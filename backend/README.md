...
> **CI**: `.github/workflows/backend.yml` runs Ruff + unit tests, applies migrations to a PostgreSQL service, and executes integration tests on every push/PR touching backend files so issues surface immediately.
